...
const config: Config = {
  ...
  organizationName: 'juananmora', // Usually your GitHub org/user name.
    ...
    [
      'classic',
      {
        docs: {
          ...
          editUrl:
            'https://github.com/juananmora/claude-code-templates/tree/main/docu/',
        },
        ...
        },
        {
          ...
          items: [
            ...
            },
            {
              ...
              href: 'https://github.com/juananmora/claude-code-templates/issues',
            },
          ],
        },
        {
          ...
          items: [
            {
              label: 'Contribute',
              href: 'https://github.com/juananmora/claude-code-templates/blob/main/CONTRIBUTING.md',
            },
            {
              label: 'License',
              href: 'https://github.com/juananmora/claude-code-templates/blob/main/LICENSE',
            },
          ],
        },
      ],
